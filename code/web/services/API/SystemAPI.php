...
class SystemAPI extends AbstractAPI {
	...
	public function getDatabaseUpdates(): array {
		...
		require_once ROOT_DIR . '/sys/DBMaintenance/oclcResourceSharingForGroups_updates.php';
		$oclcResourceSharingForGroupsUpdates = getOclcResourceSharingForGroupsUpdates();
